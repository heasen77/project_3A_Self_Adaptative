...
public class Simulation_console_CSPG1 {
    ...
    public Simulation_console_CSPG1(int h, int unit, int[] initTL1, boolean[] initTL2, int[] initCar){
    ...
    public void Simulation(Model model, int xMin, int xStop, int vSL){
        ...
        if (solver.solve()){
            ...
            System.out.println("CSP solved - Global Method 1\n");
            for (int i = 0; i <= N - 2 ; i++) {
